...
from idiom_translation.idiom_translator import train_and_save_idiom_translator, load_idiom_translator

# Proje kök yolunu ekle
sys.path.append(os.path.abspath(os.path.join(os.path.dirname(__file__), "..")))


DATA_PATH = "C:/Users/EMRULLAH/PycharmProjects/pythonProject18/data/deyimler.csv"
...
def main():
    ...
    train_and_save_idiom_translator(DATA_PATH)
    ...
    print(f"\n[+] Model kaydedildi: {os.path.join(MODEL_PATH, 'idiom_translator.pkl')}")
