...
from idiom_translation.agiz_translator import train_and_save_agiz_translator, load_agiz_translator

# Proje kök yolunu ekle
sys.path.append(os.path.abspath(os.path.join(os.path.dirname(__file__), "..")))


DATA_PATH = "C:/Users/EMRULLAH/PycharmProjects/pythonProject18/data/agiz2.csv"
...
def main():
    ...
    train_and_save_agiz_translator(DATA_PATH)
    ...
    print(f"\n[+] Model kaydedildi: {os.path.join(MODEL_PATH, 'agiz_translator.pkl')}")
